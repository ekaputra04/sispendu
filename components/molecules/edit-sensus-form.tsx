...
import { createSensus, updateSensus } from "@/lib/firestore/sensus";
...
interface EditSensusFormProps {
  data: ISensus | null | undefined;
}

export default function EditSensusForm({ data }: EditSensusFormProps) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      tanggalSensus: data?.tanggalSensus || "",
      lokasi: data?.lokasi || "",
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: async (data: ISensus) => updateSensus(data.id, data),
    onSuccess: () => {
